...
class KinderController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('kinders.index')->with('kinders', $kinders);
    }
    ...
    public function store(CreateKinderRequest $request)
    {
        ...
        Flash::success('Kontaktlar muvaffaqiyatli saqlandi.');
    ...
    public function update($id, UpdateKinderRequest $request)
    {
        ...
        Flash::success('Kontaktlar muvaffaqiyatli o\'zgartirildi.');
    ...
    public function destroy($id)
    {
        ...
        Flash::success('Kontaktlar muvaffaqiyatli olib tashlandi.');
