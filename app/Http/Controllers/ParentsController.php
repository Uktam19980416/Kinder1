...
class ParentsController extends AppBaseController
{
    ...
    public function store(CreateParentsRequest $request)
    {
        ...
        Flash::success('Ota-onalar muvaffaqiyatli saqlandi.');
    ...
    public function show($id)
    {
        ...
        if (empty($parents)) {
            Flash::error('Ota-onalar topilmadi.');
    ...
    public function update($id, UpdateParentsRequest $request)
    {
        ...
        Flash::success('Ota-onalar muvaffaqiyatli o\'zgartirildi.');
    ...
    public function destroy($id)
    {
        ...
        Flash::success('Ota-onalar muvaffaqiyatli olib tashlandi.');
