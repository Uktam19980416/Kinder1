...
?>
    ...
    <div class="col-md-6 col-lg-4 ftco-animate fadeInUp ftco-animated more-box">
        <div class="blog-entry">
          ...
          <div class="text bg-white p-4">
            ...
            <p><?=substr($kinderNew->desrciption, 0, 30)?>...</p>
            <div class="d-flex align-items-center mt-4">
              <p class="mb-0"><a href="{{ route('product.section', ['id' => $kinderNew->id]) }}" class="btn btn-secondary">Ko'proq o'qish <span class="ion-ios-arrow-round-forward"></span></a></p>
